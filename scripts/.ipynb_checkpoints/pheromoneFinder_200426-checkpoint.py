...
def memewrapper(fasta_path,
                ...
                meme_args = ['-dna','-nostatus', '-time', '18000', '-mod', 'zoops', '-nmotifs', '3', '-minw', '5', '-maxw', '10', '-revcomp'],
...
def memeRun (promoter_fasta_dir):
    ...
    for promoter_fasta_file in promoter_fasta_file_list:
        ...
        elif (meme_fasta_file.startswith("aSpec_promoters_0") or promoter_fasta_file.startswith("pheroAct_promoters_0")):
